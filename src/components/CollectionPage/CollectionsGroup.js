...
const CollectionsGroup = () => {
  ...
  const items = [
    { title: "Cafe Chair", img: "/images/CollectionImages/Cafe-Chair.png" },
    { title: "Bar Chair", img: "/images/CollectionImages/Bar-Chair.png" },
    { title: "Dining Table", img: "/images/CollectionImages/Dining-Table.png" },
    { title: "High Table", img: "/images/CollectionImages/High-Table.png" },
    { title: "Outdoor Chair", img: "/images/CollectionImages/Outdoor-Chair.png" },
    { title: "Outdoor Table", img: "/images/CollectionImages/Outdoor-Table.png" },
    { title: "Coffee Table", img: "/images/CollectionImages/Coffee-Table.png" },
    { title: "Sofa & Booths", img: "/images/CollectionImages/Sofa-Booths.png" },
  ];
    ...
    <section className='bg-[#F6F4EE]'>
      <div className="py-[60px] px-4 sm:px-6 md:px-8">
        <div className="max-w-[1280px] m-auto flex flex-col gap-[40px] sm:gap-[50px] md:gap-[60px]">
          <a href='/collection/collection-products'>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
            {items.map((item, index) => (
              ...
              >
                <div className="relative w-full min-h-[400px] sm:min-h-[400px] md:min-h-[380px] lg:min-h-[440px]">
                  <Image
                    src={item.img}
                    fill
                    alt={item.title}

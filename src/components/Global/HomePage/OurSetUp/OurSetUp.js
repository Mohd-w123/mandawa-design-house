  ...
  <div className="py-[80px] px-4">
    <div className="max-w-[1280px] m-auto flex flex-col gap-[60px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
        ...
        {/* Assembly */}
        <div className="relative group flex flex-col gap-[20px] cursor-pointer">
          <div className="relative min-h-[280px] sm:min-h-[320px] md:min-h-[380px] lg:min-h-[440px]">
            ...
            <div className="absolute top-0 w-full h-full flex justify-center items-center bg-black/50 opacity-0 group-hover:opacity-100 transition-all duration-300">
              <h4 className="mt-3 group-hover:mt-0 transition-all duration-300 font-belleza text-[20px] sm:text-[26px] md:text-[30px] lg:text-[34px] text-white">
                Assembly
              </h4>
            </div>
          </div>
          <div className="flex justify-center relative bottom-0 opacity-100 group-hover:bottom-3 group-hover:opacity-0 transition-all duration-300">
            <p className="font-belleza text-[20px] sm:text-[26px] md:text-[30px] lg:text-[34px] text-[#191919]">
              Assembly
            </p>
          </div>
        </div>
